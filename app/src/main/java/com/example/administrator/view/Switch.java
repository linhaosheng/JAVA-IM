...
public class Switch extends CompoundButton {
    ...
    private Layout makeLayout(CharSequence text) {
     Object staticLayout=new StaticLayout(text, mTextPaint, (int) Math.ceil(Layout.getDesiredWidth(text, mTextPaint)), Layout.Alignment.ALIGN_NORMAL, 1.f, 0, true);
         if(staticLayout==null){
             return null;
         }else {
             return (StaticLayout)staticLayout;
         }
